...
var ButtonGroupButtonContext = React3.createContext(void 0);
if (true) {
...
var _excluded2 = ["children", "color", "component", "className", "disabled", "disableElevation", "disableFocusRipple", "endIcon", "focusVisibleClassName", "fullWidth", "size", "startIcon", "type", "variant"];
...
var Button = React4.forwardRef(function Button2(inProps, ref) {
  const contextProps = React4.useContext(ButtonGroupContext_default);
  const buttonGroupButtonContextPositionClassName = React4.useContext(ButtonGroupButtonContext_default);
  ...
  const startIcon = startIconProp && (0, import_jsx_runtime2.jsx)(ButtonStartIcon, {
    className: classes.startIcon,
    ownerState,
    children: startIconProp
  });
  const endIcon = endIconProp && (0, import_jsx_runtime2.jsx)(ButtonEndIcon, {
    className: classes.endIcon,
    ownerState,
    children: endIconProp
  });
  const positionClassName = buttonGroupButtonContextPositionClassName || "";
  return (0, import_jsx_runtime3.jsxs)(ButtonRoot, _extends({
    ownerState,
...
true ? Button.propTypes = {
   ...
   * @default 'primary'
   */
  color: import_prop_types2.default.oneOfType([import_prop_types2.default.oneOf(["inherit", "primary", "secondary", "success", "error", "info", "warning"]), import_prop_types2.default.string]),
  /**
   * The component used for the root node.
   * Either a string to use a HTML element or a component.
   */
   ...
   * @default false
   */
  disableElevation: import_prop_types2.default.bool,
  /**
   ...
   */
  startIcon: import_prop_types2.default.node,
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
   ...
   * @ignore
   */
  type: import_prop_types2.default.oneOfType([import_prop_types2.default.oneOf(["button", "reset", "submit"]), import_prop_types2.default.string]),
  /**
   * The variant to use.
   * @default 'text'
   */
  variant: import_prop_types2.default.oneOfType([import_prop_types2.default.oneOf(["contained", "outlined", "text"]), import_prop_types2.default.string])
} : void 0;
...
var FormControl = React5.forwardRef(function FormControl2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiFormControl"
  });
  ...
  return (0, import_jsx_runtime4.jsx)(FormControlContext_default.Provider, {
    value: childContext,
    children: (0, import_jsx_runtime4.jsx)(FormControlRoot, _extends({
      as: component,
      ownerState,
...
var InputAdornment = React7.forwardRef(function InputAdornment2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiInputAdornment"
  });
...
//# sourceMappingURL=chunk-H4FIRMUS.js.map
