...
function getReactVersion() {
  const parts = React89.version.split(".");
  return {
    major: +parts[0],
    minor: +parts[1],
    patch: +parts[2]
...
function useRTGTransitionProps(_ref) {
  ...
  const handleEnter = (0, import_react60.useCallback)(normalize(onEnter), [onEnter]);
  const handleEntering = (0, import_react60.useCallback)(normalize(onEntering), [onEntering]);
  const handleEntered = (0, import_react60.useCallback)(normalize(onEntered), [onEntered]);
  const handleExit = (0, import_react60.useCallback)(normalize(onExit), [onExit]);
  const handleExiting = (0, import_react60.useCallback)(normalize(onExiting), [onExiting]);
  const handleExited = (0, import_react60.useCallback)(normalize(onExited), [onExited]);
  const handleAddEndListener = (0, import_react60.useCallback)(normalize(addEndListener), [addEndListener]);
  return Object.assign({}, props, {
    ...
    ) : (0, import_react60.cloneElement)(children, {
      ref: mergedRef
    })
  });
}
...
var Modal = (0, import_react62.forwardRef)((_ref, ref) => {
  ...
  return (0, import_jsx_runtime87.jsx)(import_jsx_runtime88.Fragment, {
    children: import_react_dom2.default.createPortal((0, import_jsx_runtime89.jsxs)(import_jsx_runtime88.Fragment, {
...
var Modal2 = React100.forwardRef(({
  ...
  const renderBackdrop = (0, import_react64.useCallback)((backdropProps) => (0, import_jsx_runtime97.jsx)("div", {
    ...backdropProps,
...
var Offcanvas = React111.forwardRef(({
  ...
  const renderBackdrop = (0, import_react70.useCallback)((backdropProps) => (0, import_jsx_runtime108.jsx)("div", {
    ...backdropProps,
...
function useOverlayOffset(customOffset) {
  ...
  const offset = (0, import_react75.useMemo)(() => ({
    name: "offset",
    options: {
      offset: () => {
        if (customOffset) {
...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime125.jsxs)(import_jsx_runtime124.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react77.cloneElement)(children, triggerProps), (0, import_jsx_runtime123.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
var TabPane = React138.forwardRef(({
  ...
  return (0, import_jsx_runtime142.jsx)(TabContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime142.jsx)(SelectableContext_default.Provider, {
      value: null,
      children: (0, import_jsx_runtime142.jsx)(Transition, {
        in: isActive,
        onEnter,
        onEntering,
        onEntered,
...
var ToastFade = React141.forwardRef((props, ref) => (0, import_jsx_runtime146.jsx)(Fade_default, {
  ...props,
  ref,
...
var Toast = React145.forwardRef(({
  ...
  return (0, import_jsx_runtime150.jsx)(ToastContext_default.Provider, {
    value: toastContext,
    children: hasAnimation && Transition ? (0, import_jsx_runtime150.jsx)(Transition, {
      in: show,
      onEnter,
      onEntering,
      onEntered,
