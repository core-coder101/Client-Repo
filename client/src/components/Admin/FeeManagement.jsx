...
export default function FeeManagement() {
  ...
  const rows = FeeData.data
    ? FeeData.data.map((feedata) => {
        return createData(
          feedata.users.name,
          feedata.Fee,
          feedata.Paid ? "True" : "False",
          feedata.Date,
          <button
            className="btn btn-primary"
            disabled={feedata.Paid}
            onClick={() => {
              GenerateStudentFeePaid(feedata.UsersID, feedata.Date);
            }}
          >
            Mark Paid
          </button>
      ...
      <div className="" style={{ padding: "15px 20px" }}>
        ...
        <div className="mt-5 ms-3">
          <p style={{ fontSize: "18px", fontWeight: "700" }}>
            Total Paid Amount : &nbsp; {FeeData.totalPaidAmount} pkr
          </p>
          <p style={{ fontSize: "18px", fontWeight: "700" }}>
            Total UnPaid Amount : &nbsp; {FeeData.totalUnPaidAmount} pkr
          </p>
        </div>
      </div>
      <CustomPopup
