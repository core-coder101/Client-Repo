    ...
    return (
        <div className='createClass'>
            ...
            <center><h2 className='protest-revolution-regular'>Parents Data</h2></center>
                    ...
                    <Popup visible={popup} onClose={() => {setPopup(false); setTimeout(()=>{setErrorMessage("")},400)}} style={{backgroundColor: "rgba(17, 16, 29, 0.95)", boxShadow: "rgba(0, 0, 0, 0.2) 5px 5px 5px 5px", padding: "40px 20px"}}>
