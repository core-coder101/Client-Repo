                        ...
                        <tbody>
                            {filteredStudentsInfo && filteredStudentsInfo.length > 0 ? filteredStudentsInfo.map((student, index) => (
                                <tr key={student.id}>
                                    ...
                                    <td>
                                        <div onClick={()=>{generatePopup(student, 'id')}} className="filterDataDiv generateID innerButtonDiv">
                                            <p>Generate ID</p>
                                ...
                                <div ref={pngElementRef} className='studentIdCardDiv' style={{backgroundColor: "white", display: "flex", flexDirection: "column", alignItems: "center", borderRadius: "1rem", padding: "15px 20px", boxShadow: "rgba(0, 0, 0, 0.5) 5px 5px 5px 5px", whiteSpace: "nowrap", width: "300px", height: "460px"}}>
                                    <div style={{width: "100%", display: "flex", flexDirection: "column", alignItems: "center"}}>
                                        ...
                                        <div style={{display: "flex", flexDirection: "column", width: "100%"}}>
                                            ...
                                            <h6 style={{fontSize: "14px"}}><span style={{color: "#5b8beb"}}>Student ID: </span>{popupInput.id}</h6>
                                            <h6 style={{fontSize: "14px"}}><span style={{color: "#5b8beb"}}>Full Name: </span>{popupInput.users.name}</h6>
                                            <h6 style={{ paddingBottom: "50px", fontSize: "14px"}}><span style={{color: "#5b8beb",}}>Emergency Contact: </span>{popupInput.parents.GuardiansPhoneNumber}</h6>
                                        </div>
                            ...
                            <Popup visible={popup} onClose={() => {setPopup(false); setTimeout(()=>{setErrorMessage("")},400)}}  style={{backgroundColor: "#11101de9", boxShadow: "rgba(0, 0, 0, 0.2) 5px 5px 5px 5px", padding: "40px 20px"}}>
